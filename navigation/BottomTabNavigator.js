...
export default function BottomTabNavigator({ navigation, route }) {
  ...
  return (
    <Tab.Navigator
      barStyle={{ backgroundColor: '#fbfbfb', borderTopColor: '#f00002', borderStyle: 'dashed', borderColor: '#f00002', height: 60, }}
    >
      <Tab.Screen
        name="Home"
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ tintColor }) => (
            <View>
              <Image source={require('../src/assets/img/experience.png')} style={{ width: 32, height: 32, }} />
            </View>),
        }}
      />
      <Tab.Screen
